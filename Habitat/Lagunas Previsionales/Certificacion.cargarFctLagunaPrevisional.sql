create PROCEDURE Certificacion.cargarFctLagunaPrevisional(OUT codigoError VARCHAR(10))
BEGIN
    /*-----------------------------------------------------------------------------------------
    ...
    - Descripción corta del módulo              : Procedimiento que carga FCTLagunaPrevisional
    ...
    SET cstNombreProcedimiento                  = 'cargarFctLagunaPrevisional';
    ...
    -------------------------------------------------------------------------------------------
        ...
        CALL Certificacion.cargarFctLagunaPrevisionalManual(ldtPeriodoInformar, codigoError);
